import { createAlantuBookPhysics } from "./alantu-book-physics-box3d024.js";
...
export function createAlantuBookCore(options){
  ...
  function step(now){
    ...
    if(activeTurn){
      ...
      const visuallyStill=Math.abs(activeTurn.velocity)<.025;

      if(!dragState&&hingeAtTarget&&visuallyStill){
